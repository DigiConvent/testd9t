  ...
  <div>
    ...
    <div class="card flex justify-center">
      <Form class="flex flex-col gap-4 w-full" @submit="handle_submit">
        ...
        <div class="flex flex-col gap-1">
          <FloatLabel variant="in">
            <InputText id="first_name" v-model="first_name" name="first_name" type="text" fluid />
        ...
        <div class="flex flex-col gap-1">
          <FloatLabel variant="in">
            <InputText id="last_name" v-model="last_name" name="last_name" type="text" fluid />
        ...
        <div class="flex flex-col gap-1">
          ...
          <Message v-if="errors.date_of_birth" severity="error" size="small" variant="simple">{{
